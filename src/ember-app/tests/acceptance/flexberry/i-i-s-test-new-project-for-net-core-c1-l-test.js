...
moduleForAcceptance('[AGAT] Acceptance | i i s test new project for net core c1 l');

test('testing i-i-s-test-new-project-for-net-core-c1-l', function(assert) {
  visit('/i-i-s-test-new-project-for-net-core-c1-l');
